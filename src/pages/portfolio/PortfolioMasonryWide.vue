<template>
    <div class="main-container">
        ...
        <Breadcrumb>
            <template slot="breadcrumb">
                <div class="breadcrumb_box text-center">
                    <h2 class="breadcrumb-title">Portfolio Masonry Wide</h2>
                    ...
                    <ul class="breadcrumb-list">
                        ...
                        <li class="breadcrumb-item active">Portfolio Masonry Wide</li>
                    </ul>
                    <!-- breadcrumb-list end -->
                </div>
            </template>
        ...
        <div class="portfolio-pages-wrapper masonry-activation section-space--pt_100 section-space--pb_70 border-bottom">
